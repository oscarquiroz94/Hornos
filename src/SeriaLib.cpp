...
*/
SeriaLib::SeriaLib(const char *device, unsigned int bauds)
{
    ...
    char errorOpening = openDevice(device, bauds);
    if (errorOpening == 1)
        IEsp32::serial_print("Serial ");
        IEsp32::serial_print(device);
        IEsp32::serial_print(" connected\n");
